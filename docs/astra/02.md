...
# Установка и настройка 1С и Postgres
...
* проверяем службу;
```
sudo systemctl enable postgrespro-1c-16
...
* скачать базу для проведения теста  
![testGileva2.1.1.43.dt](./files/testGileva2.1.1.43.dt)
